package com.IG308.chessCorner.configuration;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public static final String[] AUTHORIZED_REQUESTS_ANYBODY = new String[]{"/", "/css/**", "/images/**", "/product/**", "/register/**", "/basket/**", "/about/**"};
    public static final String[] AUTHORIZED_REQUESTS_LOGGED = new String[]{"/checkout"};
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers(AUTHORIZED_REQUESTS_LOGGED).hasRole("ADMIN") // For the request to "/admin", the user needs to be an admin
                ...
                .and()
                .formLogin().defaultSuccessUrl("/", true) // We define the login part here. + après un correct login, remettre sur la page d'accueil
