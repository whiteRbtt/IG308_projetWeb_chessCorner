...
<body>
    ...
    <nav class="navbar" role="navigation">
        <div class="d-flex w-25 justify-content-center align-items-center flex-nowrap p-2">
            <a class="navbar-brand" href="#">
                <img src='<spring:url value="/images/logo.png"/>' alt="logo" width="40">
            </a>
            <h2 class="ml-2 text-nowrap">Chess corner</h2>
        </div>

        <div class="d-flex collapse w-75 justify-content-end align-items-center flex-nowrap p-2">
    ...
    <div class="d-flex justify-content-center align-items-center m-5 border border-danger">
